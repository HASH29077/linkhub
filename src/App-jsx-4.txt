...
const LINKS = [
  { label: 'Twitter', tag: 'X', url: 'https://twitter.com/imnotfabrizio' },
  { label: 'GitHub', tag: 'GH', url: 'https://github.com/HASH29077' },
  { label: 'HashQuiz', tag: 'WWW', url: 'https://hashfun-self.vercel.app/' },
  { label: 'WhatsApp', tag: 'WA', url: 'https://wa.me/2348152164323' },
  { label: 'Email', tag: '@', url: 'mailto:omotayomichael666@gmail.com' },
];

const PROFILE = {
  name: 'Hash',
  handle: 'Omotayo Ayomide Michael',
  bio: 'Building HashQuiz and shipping side projects, one commit at a time.',
};
  ...
  return (
    <div className={`min-h-screen ${bg} ${text} font-body flex items-center justify-center px-5 py-16 transition-colors duration-500`}>
      <div className="w-full max-w-sm">
        ...
        >
          <p className={`font-mono text-sm ${muted} mb-3`}>{PROFILE.handle}</p>
